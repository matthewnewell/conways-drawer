 ...
 */
export default function DrawerLayout({ agent, journal, children, scrollMain = true }) {
    ...
    return (_jsxs("div", { className: `cd-row${active ? ' cd-row--open' : ''}`, children: [_jsx("div", { className: `cd-main${scrollMain ? ' cd-main--scroll' : ''}`, children: children }), active && (_jsx("aside", { className: "cd-panel", children: active === 'agent' ? _jsx(AgentPanel, { ...agent }) : _jsx(JournalPanel, { ...journal }) })), _jsx("div", { className: "cd-rail", children: TABS.map((t) => {
